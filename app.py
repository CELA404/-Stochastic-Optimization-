...
def load_ev_data():
    file_path = "SYNTHETIC_EV_DATA_sample.csv"

    # Αν το αρχείο υπάρχει ήδη, φόρτωσέ το
    ...
    # ==================== ΑΥΤΟΜΑΤΗ ΛΗΨΗ ΑΠΟ GITHUB ====================
    raw_url = "https://raw.githubusercontent.com/CELA404/-Stochastic-Optimization-/refs/heads/main/SYNTHETIC_EV_DATA_sample.csv"

    st.sidebar.info("📥 Downloading sample dataset from GitHub...")

    try:
        with st.spinner("Downloading sample dataset (≈3MB)... Please wait"):
        ...
        df = pd.read_csv(file_path)
        st.sidebar.success("✅ Sample dataset downloaded and loaded!")
        return df
        ...
        uploaded_file = st.sidebar.file_uploader(
            "Upload SYNTHETIC_EV_DATA_sample.csv manually",
            type=["csv"]
        )
